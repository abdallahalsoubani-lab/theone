...
/** Clinician sessions summary — DOCTOR entry (Prompt 40 §1.1: admin + doctor
 *  only; secretary/therapist are denied by the permission). */
export default async function DoctorClinicianSummaryPage({
  params,
  searchParams,
}: {
  ...
  return (
    <ClinicianSummaryReport
      range={range}
      basePath="/doctor/reports/clinicians"
