  ...
  async function inner(input): Promise<{ id: string }> {
    ...
    await db.clinicSettings.update({
      ...
      data: {
        ...
        bookingDispatchMode: input.bookingDispatchMode,
        rescheduleDispatchMode: input.rescheduleDispatchMode,
        cancellationDispatchMode: input.cancellationDispatchMode,
        ...
        cancellationMessageDelayMinutes: input.cancellationMessageDelayMinutes,
